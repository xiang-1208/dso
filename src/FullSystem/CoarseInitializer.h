...
public:
	...
	Pnt* points[CAM_USE][PYR_LEVELS];
	int numPoints[CAM_USE][PYR_LEVELS];
...
private:
	// 2021.11.8
	Mat33 K[CAM_USE][PYR_LEVELS];
	Mat33 Ki[CAM_USE][PYR_LEVELS];
	double fx[CAM_USE][PYR_LEVELS];
	double fy[CAM_USE][PYR_LEVELS];
	double fxi[CAM_USE][PYR_LEVELS];
	double fyi[CAM_USE][PYR_LEVELS];
	double cx[CAM_USE][PYR_LEVELS];
	double cy[CAM_USE][PYR_LEVELS];
	double cxi[CAM_USE][PYR_LEVELS];
	double cyi[CAM_USE][PYR_LEVELS];
	// 2021.11.8
	int w[PYR_LEVELS];
	int h[PYR_LEVELS];
