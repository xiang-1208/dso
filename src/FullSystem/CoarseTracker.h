...
public:
	...
	// 2021.11.9
	Mat33f K[CAM_USE][PYR_LEVELS];
	Mat33f Ki[CAM_USE][PYR_LEVELS];
	float fx[CAM_USE][PYR_LEVELS];
	float fy[CAM_USE][PYR_LEVELS];
	float fxi[CAM_USE][PYR_LEVELS];
	float fyi[CAM_USE][PYR_LEVELS];
	float cx[CAM_USE][PYR_LEVELS];
	float cy[CAM_USE][PYR_LEVELS];
	float cxi[CAM_USE][PYR_LEVELS];
	float cyi[CAM_USE][PYR_LEVELS];
	// 2021.11.9
	int w[PYR_LEVELS];
	int h[PYR_LEVELS];
...
private:
	...
	float* idepth[CAM_USE][PYR_LEVELS];
	...
	// pc buffers
	float* pc_u[CAM_USE][PYR_LEVELS];
	float* pc_v[CAM_USE][PYR_LEVELS];
	float* pc_idepth[CAM_USE][PYR_LEVELS];
	float* pc_color[CAM_USE][PYR_LEVELS];
	int pc_n[CAM_USE][PYR_LEVELS];
